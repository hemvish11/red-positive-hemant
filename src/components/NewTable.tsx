...
const Table: React.FC<propsDataType> = ({
    ...
    return (
        <div>
            ...
            <table className='border-2 border-black rounded-lg shadow-lg sm:m-5 sm:p-5 sm:max-w-[90%]'>
                ...
                <tbody >
                    ...
                    {items.map((item, index) =>
                        <tr className={`sm:border-2 border-black rounded-lg m-5 sm:p-5 ${isChecked[index] ? "bg-green-200" : ""}`}
                            key={index}>
                            <td className='sm:border-2 border-black p-5'>
                            ...
                            <td className='min-w-60 sm:border-2 sm:order-black sm:p-5 mx2 whitespace-pre-wrap break-words sm:max-w-36'>{index + 1}</td>
                            <td className='min-w-60 sm:border-2 sm:order-black sm:p-5 mx2 whitespace-pre-wrap break-words sm:max-w-36'>{item.name}</td>
                            <td className='min-w-60 sm:border-2 sm:order-black sm:p-5 mx2 whitespace-pre-wrap break-words sm:max-w-36 '>{item.phoneNumber}</td>
                            <td className='min-w-60 sm:border-2 sm:order-black sm:p-5 mx2 whitespace-pre-wrap break-words sm:max-w-96'>{item.email}</td>
                            <td className='min-w-60 sm:border-2 sm:order-black sm:p-5 mx2 whitespace-pre-wrap break-words sm:max-w-36'>{item.hobbies}</td>
                            <td className='min-w-60 sm:border-2 sm:order-black p-5 sm:whitespace-pre-wrap sm:break-words sm:max-w-36'>
